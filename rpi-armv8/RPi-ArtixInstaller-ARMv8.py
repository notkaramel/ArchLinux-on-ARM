...
# Variables:
root_filesystem = "armtix-openrc-20220601.tar.xz"
root_filesystem_url = "https://armtixlinux.org/images/" + root_filesystem

# Select SD card partition name via input
print("Available partitions:")
os.system("sudo fdisk -l | grep -i 'Disk /dev/'")

print("Select SD card partition name (e.g.: sda): ", end="")
partition = input()
...
print("Have you already formatted the partition? (y/n): ", end="")
formatted = input()
...
if formatted == "n":
    ...
    print("""
        ...
        n, p, 1, ENTER, +300M -> create first partition.
        t, c -> set type to W95 FAT32 (LBA).
        n, p, 2, ENTER, ENTER, -> create second partition (/root/).
